...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_relatedProduct(self, obj):
        queryset = Product.objects.filter(is_available=True, product_status='Ok',category__category_name = obj.category.category_name).exclude(id=obj.id).order_by('-create_at')[:4]
