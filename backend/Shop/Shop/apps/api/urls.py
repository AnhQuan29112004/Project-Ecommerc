...
from Shop.apps.Store.views import RatingDeletaView, RatingCreateView, ProductSameTagView, vendor_list_api,VendorProductListView, ProductListView, CategoryListView, ProductDetailView
