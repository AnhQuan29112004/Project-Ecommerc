...
from Shop.apps.Store.views import RatingUpdateView,RatingDeletaView, RatingCreateView, ProductSameTagView, vendor_list_api,VendorProductListView, ProductListView, CategoryListView, ProductDetailView
